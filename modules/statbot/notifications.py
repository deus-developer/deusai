...
from utils import get_last_raid_date, get_when_raid_text
...
class NotificationsModule(BasicModule):
    ...
    def __init__(self, event_manager: EventManager, message_manager: MessageManager, dispatcher: Dispatcher):
        ...
        self.event_manager.scheduler.add_job(
            self._notification_when_raid_3,
            'cron',
            day_of_week='mon-sun',
            hour='6,22'
        )
        ...
        self.event_manager.scheduler.add_job(
            self._notification_when_raid_tz(kms=[24, ]),
            'cron',
            day_of_week='mon-sun',
            hour='0,8',
            minute=57
        ...
        self.event_manager.scheduler.add_job(
            self._notification_when_raid_tz(kms=[32, ]),
            'cron',
            day_of_week='mon-sun',
            hour='0,8',
            minute=47
        ...
        self.event_manager.scheduler.add_job(
            self._notification_pipboy_update,
            'cron',
            day_of_week='sun',
            hour='10'
        )  # Обновление пип-боев
    ...
    def _notification_pipboy_update(self):
        ...
        query = (
            ...
            .where(
                ...
                (Player.last_update <= pipboy_expire_date)
            )
        )
