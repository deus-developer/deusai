...
from models import RaidAssign, Player, Settings
from models.raid_assign import RaidStatus
from modules import BasicModule
from utils import next_raid, last_raid
from utils.functions import get_link
from config import settings

from core import EventManager, MessageManager, CommandFilter, Update, Handler
from utils.functions import CustomInnerFilters, walk_time
...
class NotificationsModule(BasicModule): #TODO: Переработать, добавить "будильники"
    ...
    def _notification_confirmed(self):
        ...
        for user in users:
            self.message_manager.send_message(  chat_id=user['chat_id'],
    ...
    def _notification_when_raid_3(self):
        ...
        users = RaidAssign.select(Player.telegram_user_id.alias('chat_id'), Player.nickname.alias('nickname'))\
                            ...
                            .where(RaidAssign.status_id.not_in([RaidStatus.IN_PROCESS, RaidStatus.CONFIRMED])
