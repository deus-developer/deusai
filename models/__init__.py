...
MODELS = {
    ...
    PlayerSendedThrough, Taking, TakingStatus, Feedback, Rank,
    SPItem, SPProcess, Settings, Trigger, Vote, KMProfit, LeadTime,
    VoteAnswer, AnswerPlayerThrough, Item, InventoryItem, PVP,
    RaidsInterval, Boss, BossPlayerThrough,
    ShopItem, ShopPurchase, Auction, AuctionMember
}
